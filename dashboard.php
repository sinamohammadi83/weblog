    ...
    <main class="flex w-full lg:max-w-screen-xl">
        <div class="w-9/12 border-l flex flex-col gap-y-6 p-8 pt-5 pr-4">
            ...
            <div class="border-b pb-2">
                <a href="" class="text-sm border-b border-b-black h-full pb-2">پیش نویس ها</a>
                <a href="" class="text-sm pb-2 mr-5">پست های منتشر شده</a>
            </div>
            <div class="border-b border-b-slate-700 flex justify-between pb-5">
                <div class="flex gap-x-10 pr-10">
                    <div class="text-sm">1</div>
                    <div class="text-sm">تستی</div>
                    <div class="text-sm">ورزش</div>
                </div>
