                ...
                <div class="flex p-4 border-b">
                    <div class="w-9/12">
                        ...
                        <div class="flex gap-x-4 items-center">
                            <span class="text-slate-700 bg-gray-300 text-xs p-1 px-2 rounded"><?php echo $post['category_id'] ?></span>
                            <span class="text-xs text-slate-400">خواندن 4 دقیقه</span>
                        </div>
                    </div>
                    <div class="w-3/12">
                        <img src="<?php echo $post['picture'] ?>" class="w-40 h-40 rounded" alt="">
                    </div>
                </div>
            <?php } ?>
        </div>
        <div class="w-4/12 flex flex-col items-center pt-5 rounded-md">
            ...
            <div class="w-10/12">
                ...
                <div class="grid grid-cols-5 gap-2">
                    <div class="border border-black rounded-md text-sm py-1 px-2">
                        کامپیوتر
                    </div>
                    <div class="border border-black rounded-md text-sm py-1 px-2">
                        کامپیوتر
