...
<body>
    <div class="flex">
        <div class="w-72 bg-white py-4 border-l shadow h-screen">
            <div class="flex items-center gap-x-2 mb-20 px-5">
                <div>
            ...
            <div class="flex flex-col gap-y-5">
                <a href="index.php" class="flex gap-x-2 <?php if ($_SERVER['QUERY_STRING'] == "") echo "border-l-2 border-blue-500 text-blue-500" ?> px-5">
                    <span>
                ...
                <a href="index.php?s=post&a=index" class="flex gap-x-2 <?php if ($_SERVER['QUERY_STRING'] == "s=post&a=index") echo "border-l-2 border-blue-500 text-blue-500" ?> px-5">
                    <span>
                ...
                <a href="index.php?s=category&a=index" class="flex gap-x-2 <?php if ($_SERVER['QUERY_STRING'] == "s=category&a=index") echo "border-l-2 border-blue-500 text-blue-500" ?> px-5">
                    <span>
                ...
                <a href="index.php?s=user&a=index" class="flex gap-x-2 <?php if ($_SERVER['QUERY_STRING'] == "s=user&a=index") echo "border-l-2 border-blue-500 text-blue-500" ?> px-5">
                    <span>
            ...
            <div class="px-5 fixed bottom-20 right-0">
                <a href="../logout.php" class="flex gap-x-2">
                    <span>
        ...
        <div class="w-full flex flex-col items-center h-screen overflow-y-auto px-20 pt-20 from-blue-100 via-blue-200 via-30% to-blue-300/60 from-20% to-70% bg-gradient-to-r">
            <?php
            include '../jdf.php';
