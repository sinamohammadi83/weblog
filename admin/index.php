...
<body>
    <div class="flex">
        <div class="w-72 bg-white p-4 border-l shadow h-screen">
            <div class="flex items-center gap-x-2 mb-20">
                <div>
                    <img src="../public/images/post/6132328418.jpg" class="w-16 h-16 object-cover rounded-full" alt="">
                </div>
                <div>سینا محمدی</div>
            </div>
            <div class="flex flex-col gap-y-4 px-5 mb-72">
                ...
                <a href="index.php?s=post&a=index" class="flex gap-x-2">
                    <span>
                ...
                <a href="index.php?s=category&a=index" class="flex gap-x-2">
                    <span>
                ...
                <a href="index.php?s=user&a=index" class="flex gap-x-2">
                    <span>
